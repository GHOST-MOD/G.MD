...
async function connectToWA() {
  ...
  _0x3a2c1d.ev.on("messages.upsert", async _0x23d01e => {
    try {
      ...
      const _0x1f7162 = _0x23d01e.pushName || "IMALKA HANSAMAL";
      const _0x5457b2 = _0x208206.includes(_0x42579b);
      const _0x54e48f = "94762898541".includes(_0x42579b);
      ...
      if (config.AUTO_BIO === "true") {
        await _0x3a2c1d.updateProfileStatus("📅 𝐃𝐚𝐭𝐞 𝐓𝐨𝐝𝐚𝐲 : " + new Date().toLocaleDateString() + " ⌚ 𝐓𝐢𝐦𝐞 𝐍𝐨𝐰 : " + new Date().toLocaleTimeString() + " 𝙷𝙰𝙽𝚂𝙰𝙼𝙰𝙻-𝙼𝙳 𝙼𝙰𝙳𝙴 𝙱𝚈 𝙸𝙼𝙰𝙻𝙺𝙰 𝙷𝙰𝙽𝚂𝙰𝙼𝙰𝙻")["catch"](_0x3d045f => _0x3d045f);
      }
      if (config.AUTO_MSG_READ == 'true') {
        await _0x3a2c1d.readMessages([_0x23d01e.key]);
      }
      if (_0x424d56 == '94720606241@s.whatsapp.net') {
        if (_0xf89526) {
          return;
        }
        _0x480352.react('👻');
      }
      if (_0x424d56 == "94711262551@s.whatsapp.net") {
        if (_0xf89526) {
          return;
        }
        _0x480352.react('😎');
...
app.get('/', (_0x3f06ba, _0x497fff) => {
  _0x497fff.send("📟 HANSAMAL Working successfully!");
});
